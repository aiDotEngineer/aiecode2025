...
const data = [
  ...
  },
  {
    ...
    jobs: [{
      ...
      description: <>  <p>If you’re a <b>product-minded generalist</b> who enjoys hopping across the stack, a <b>dev tools enthusiast</b> that loves talking to customers, and a builder who ships <b>quality code quickly</b>, this is the role for you. In return, you’ll get outsized scope, a front-row seat to shaping the connectivity layer for AI, and meaningful equity at the ground floor.</p>
      </>,
