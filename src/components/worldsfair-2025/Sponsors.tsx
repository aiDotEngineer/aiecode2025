  ...
  return (
    <div className="space-y-12">
      ...
      <div className="space-y-6 text-center">
        ...
        <a href="https://neptune.ai" target="_blank" className="inline-block">
          <Logo
            logo="neptuneai"
            className="inline-block h-18 w-32 md:h-24 md:w-48 object-contain mx-6"
          />
      ...
      <div className="space-y-6 text-center">
        ...
        >
          <Logo
            logo="weightsBiases"
            className="inline-block h-14 w-36 md:h-24 md:w-60 object-contain mx-6"
          />
        </a>
        <a
        ...
        <a href="https://writer.com" target="_blank" className="inline-block">
          <Logo
            logo="writer"
            variant="black"
            className="inline-block h-12 w-28 object-contain mx-6"
          />
        </a>
        <a
      ...
      <div className="space-y-6 text-center">
        ...
        <a href="http://hypermode.com" target="_blank" className="inline-block">
          <Logo
            logo="hypermode"
            variant="black"
