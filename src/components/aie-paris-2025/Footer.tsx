        ...
        <div className="lg:flex lg:justify-between">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-3 whitespace-nowrap">
            ...
            <div className="space-y-4">
              ...
              <Link href="https://www.koyeb.com/docs/legal/global-events-tos" aria-label="Terms of Service" className="block text-gray-on-white text-sm">AIE Paris Terms of Service</Link>
