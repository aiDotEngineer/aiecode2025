...
>(({ side = 'right', className, children, ...props }, ref) => (
  <SideDrawerPortal>
    <SideDrawerOverlay>
      ...
      >
        {children}
        <SideDrawerPrimitive.Close className="ring-offset-background focus:ring-ring data-[state=open]:bg-secondary fixed left-4 top-4 z-30 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none">
