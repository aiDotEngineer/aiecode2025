          ...
          <div className="flex flex-col gap-4 py-4 sm:flex-row sm:items-center sm:gap-8 lg:h-[70px] lg:py-0">
            ...
            <div className="flex items-center">
              <input
                ...
                className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 focus:ring-2 flex justify-center"
              />
              <label
...
function getDatesOfSessions(sessions: SessionEvent[]) {
...
function groupSessionsByDate(sessions: SessionEvent[]) {
