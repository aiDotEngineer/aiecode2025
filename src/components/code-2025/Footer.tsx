/* no-eslint-disable jsx-a11y/anchor-is-valid */
        ...
        <div className="lg:flex lg:justify-between">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-3 whitespace-nowrap">
            ...
            <div className="space-y-4">
              ...
              <a href="https://ti.to/software-3/ai-engineer-worlds-fair-2025" target="_blank" className="block text-gray-on-white text-sm">
                World's Fair 2025
              </a>
              <Link
