      ...
      <div className="mt-20">
        <Tiles minSize={16}>
          ...
          <WhatsNextCard
            ...
            text="We've curated 6+ workshops for you to choose from, servicing everyone from experienced engineers just starting with AI Engineering, to experienced AI engineers looking to get an edge on the competition."
