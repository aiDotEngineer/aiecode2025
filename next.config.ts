...
const mappings = {
  ...
  'https://wf2025.ai.engineer/worldsfair/2025/:path*': [
...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      {
        source: '/worldsfair',
        destination: 'https://wf2025.ai.engineer/worldsfair/2025', 
        permanent: false,
      },
      // {
      //   source: '/ai',
    ...
    return {
      beforeFiles: [
        ...
        ...directMappings2.map(path => ({
          source: `/${path}`,
          destination: `https://wf2025.ai.engineer/${path}`
        })),
      ...
      afterFiles: [
        ...
        // },
        {
          ...
          destination: 'https://wf2025.ai.engineer/worldsfair/2025/:path*',
        }
      ],
      fallback: [
